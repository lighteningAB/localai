...
package com.nothing.localai.databinding;
...
public final class ActivityStatusBinding implements ViewBinding {
  ...
  private ActivityStatusBinding(@NonNull LinearLayout rootView, @NonNull TextView statusText) {
  ...
  public static ActivityStatusBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new ActivityStatusBinding((LinearLayout) rootView, statusText);
    }
